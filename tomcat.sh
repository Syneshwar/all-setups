...
wget https://dlcdn.apache.org/tomcat/tomcat-9/v10.1.43/bin/apache-tomcat-10.1.43.tar.gz
...
sed -i '58  a\<user username="tomcat" password="admin@123" roles="manager-gui, manager-script"/>' apache-tomcat-10.1.43/conf/tomcat-users.xml
